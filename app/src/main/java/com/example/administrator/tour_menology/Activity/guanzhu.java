...
public class guanzhu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取登录用户信息
        utils = new PreferenceUtils(guanzhu.this);
        ...
        toolbart.setText("TA的关注");

        mlistview = (ListView) findViewById(R.id.guanzhu_list);
    ...
    private void initdata() {
        ...
        String url ="http://bobtrip.com/tripcal/api/member/listTaAttention.action?memberId="+id+"&attentionId="+
                memberId;
        ...
        OkHttpUtils.get().url(url).build().execute(new StringCallback() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    guanzhu_adapter adapter =new guanzhu_adapter(mlist,guanzhu.this);
