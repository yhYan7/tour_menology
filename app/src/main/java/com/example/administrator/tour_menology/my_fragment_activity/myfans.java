 ...
 */
public class myfans extends AppCompatActivity implements BasePullLayout.OnPullCallBackListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent =new Intent(myfans.this, zhuye.class);
    ...
    public void init(){
        ...
        toolbar_title.setText("我的粉丝");
        toolbar_back = (ImageButton) findViewById(R.id.toolbar_back);
//        bianji = (Button) findViewById(R.id.hd_bianji);

        mPullLayout = (PullLayout) findViewById(R.id.my_fans_pulllayout);
        mPullLayout.setOnPullListener(this);
        mListView3 = (ListView) findViewById(R.id.myfans_list);
...
//        bianji.setOnClickListener(mListener);
    ...
    private void initDate(int pager, String unitType, String keyword, String memberId, final boolean isRefresh) {
        String URL = "http://bobtrip.com/tripcal/api/personCenter/listMyFans.action?memberId=" + memberId;

        OkHttpUtils.get().url(URL).build().execute(new StringCallback() {
            @Override
            public void onError(Call call, Exception e) {
                mPullLayout.finishPull();
                Toast.makeText(myfans.this, "暂无数据", Toast.LENGTH_SHORT).show();
            }
