package com.example.administrator.tour_menology.viewpager;
...
public class NewViewPager extends ViewPager {
    ...
    private jingcaiyouxi act1;
    private Main_Fragment act;
    ...
    public void setInfinateAdapter(Main_Fragment act, Handler handler, PagerAdapter adapter)
    {
        this.act = (Main_Fragment) act;
        this.handler = handler;
        setAdapter(adapter);
    }

    public void setInfinateAdapter2(jingcaiyouxi act1, Handler handler, PagerAdapter adapter)
    {
        this.act1 = (jingcaiyouxi) act1;
        this.handler = handler;
        setAdapter(adapter);
    }
